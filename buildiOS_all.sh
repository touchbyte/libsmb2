...
#make clean
#
#export LDFLAGS="-Wc,-fembed-bitcode,-fapplication-extension -Xlinker -platform_version -Xlinker mac-catalyst -Xlinker 13.0 -Xlinker 10.15"
#CHOST=x86_64-apple-darwin SDK=macosx TARGET=x86_64-apple-ios13.0-macabi ./iconfigure x86_64 --without-libkrb5 --disable-werror
#make
#make install

#make clean
#export LDFLAGS="-Wc,-fembed-bitcode,-fapplication-extension -Xlinker -platform_version -Xlinker mac-catalyst -Xlinker 13.0 -Xlinker 11.0"
#CHOST=aarch64-apple-darwin22 SDK=macosx TARGET=arm64-apple-ios13.0-macabi ./iconfigure arm64 --without-libkrb5 --disable-werror
#make
#make install
exit
